...
$(function() {
	...
	//유효성검사 flag 변수
	var idck = false;
	$("input").keydown(function(evt) { if (evt.keyCode == 13) return false; })
    ...
    <div class="container py-4">
      <div class="row py-2">
        <div class="col-md-6 py-3 my-3"> 
          ...
          <h3>이야기를 나눠보세요.</h3>
          <div class="col-12">
          	<img alt="" src="/images/e5b6795c8d4e1f38b91c3c836a5875b2.gif" class="w-100">
          </div>
        </div>
        <div class="col-md-6 py-3 my-3 bg-snowgray card">
        	 <form method="post" action="/member/signup" class="text-left card-body" id="signupForm">
						<div class="form-group small">
							<label for="id" class="font-weight-bolder">festagram 계정 이메일 </label>
						...
						<div class="form-group small">
							<label for="name" class="font-weight-bolder">이름</label>
						...
						<div class="form-group small">
							<label for="phone" class="font-weight-bolder">휴대폰 번호</label>
						...
						<div class="form-group small">
							<div class="font-weight-bolder mb-2">생일</div>
